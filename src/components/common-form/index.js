        ...
        content = (
          <div className=" relative flex items-center mt-8">
            <Input
              ...
              className="w-full rounded-md h-[60px] px-4 border bg-gray-100 text-lg outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:bg-white focus:drop-shadow-lg focus-visible:outline-none focus-visible:ring-offset-0"
            />
          </div>
        );
        break;
